...
class PortfolioService:
    ...
    async def get_user_accounts(
        ...
        try:
            ...
            return [
                PortfolioAccountRead.model_validate(account, from_attributes=True)
                for account in accounts
            ]

        except Exception as e:
            logger.error(f"Failed to get user portfolio accounts: {type(e).__name__}: {str(e)}")
            raise PortfolioError("Failed to retrieve portfolio accounts")

    async def get_account_by_id(self, user_id: UUID, account_id: UUID) -> PortfolioAccountRead:
        ...
        try:
            ...
            return PortfolioAccountRead.model_validate(account, from_attributes=True)
    ...
    async def create_account(
        self, user_id: UUID, account_data: PortfolioAccountCreate
    ) -> PortfolioAccountRead:
    ...
    async def update_account(
        self, user_id: UUID, account_id: UUID, account_update: PortfolioAccountUpdate
    ) -> PortfolioAccountRead:
        ...
        try:
            ...
            return PortfolioAccountRead.model_validate(updated_account, from_attributes=True)
    ...
    async def deactivate_account(self, user_id: UUID, account_id: UUID) -> bool:
        ...
        try:
            ...
            deactivate_data = PortfolioAccountUpdate(is_active=False)
    ...
    async def get_accounts_by_type(
        ...
        try:
            ...
            raise PortfolioError("Failed to retrieve portfolio accounts by type")
    ...
    async def get_account_count(self, user_id: UUID, include_inactive: bool = False) -> int:
        ...
        try:
            ...
            raise PortfolioError("Failed to count portfolio accounts")
    ...
    async def search_accounts(
        ...
        try:
            ...
            raise PortfolioError("Failed to search portfolio accounts")
