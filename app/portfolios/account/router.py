...
from app.portfolios.account.schema import AccountCreate, AccountResponse, AccountUpdate
from app.system.audit.crud import audit_log_crud
...
async def search_accounts(
    *,
    ...
    try:
        ...
        accounts_response = [
            AccountResponse.model_validate(acc, from_attributes=True) for acc in accounts
        ]
...
async def get_user_accounts(
    *,
    ...
    try:
        ...
        accounts_response = [
            AccountResponse.model_validate(acc, from_attributes=True) for acc in paginated_accounts
        ]
